...
export default function AdminDashboard() {
  ...
  const branchName = isManager
    ? branches.find(b => b.id === targetBranchId)?.name.replace("Surya Mens & Women's PG — ", '') || ''
    : ''
              ...
              return (
                <div key={branch.id} className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="font-medium text-foreground truncate max-w-[140px]">{branch.name.replace("Surya Mens & Women's PG — ", '')}</span>
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-foreground truncate">{branch.name.replace("Surya Mens & Women's PG — ", '')}</p>
