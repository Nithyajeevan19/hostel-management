...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const branchName = currentUser?.role === 'branch_manager'
    ? branches.find(b => b.id === currentUser.branchId)?.name.replace("Surya Mens & Women's PG — ", '')
    : null
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 p-6 border-b border-white/10">
          <Link href="/admin" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="text-lg font-bold tracking-tight">Surya Mens & Women&apos;s PG</span>
